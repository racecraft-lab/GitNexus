...
export const zhCN = {
  ...
  'help.option.analyze.enrichClusters': '启用 LLM 生成的社区聚类语义名称和摘要（可选）',
  'help.option.analyze.clusterEnrichmentBatchSize': '每次富化 LLM 调用处理的聚类数量',
