...
This project is indexed by GitNexus as **GitNexus** (46855 symbols, 68359 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
